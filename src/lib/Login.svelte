...
<div class="login-form">
    <form onsubmit="{applyLogin}">
        <div class="label-input">
            ...
            <input type="text" name="login" bind:value={login} id="login" class="input-line">
        </div>
        
        <div class="label-input">
            <label for="password" class="input-label">Password</label>
            <input type="password" name="password" bind:value={password} id="password" class="input-line">
        </div>
